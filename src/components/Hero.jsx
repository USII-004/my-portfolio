  ...
  return (
    <div className='px-4 py-6 md:grid-cols-2 md:grid' id='home'>
      ...
      <div className='py-4 w-full md:py-8 md:w-[70%] mx-auto'>
        ...
        <div className='flex justify-between w-full mx-auto my-4 md:my-8'>
        <a href='#' >
          <div className='flex p-3 mx-2 text-xs text-white border rounded-md bg-slate-800 border-slate-800 md:p-4 md:text-lg md:mx-4 hover:bg-slate-900'>
